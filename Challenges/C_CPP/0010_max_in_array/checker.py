    ...
    if 'runtime_analysis_done' in overall_report:
        ...
        for report in test_case_report_list:
            ...
            # output_match == None means the user might have tried to print to outfile
                ...
                if 'source_code__arr_i_minux_max' in overall_report:
                    tag = "INCREMENTAL_3_MAX_IN_ARRAY_UNSIGNED_OVERFLOW_"
                else:
                    tag = ""
                util.addFinding("A test case failed!", 0, tag, "TEST_100006")
            else:
                success_count += 1
